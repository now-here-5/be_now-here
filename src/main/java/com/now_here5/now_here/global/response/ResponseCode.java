...
public enum ResponseCode {
    ...
    SENDER_LIST_QUERY_SUCCESS(200, "M005", "받은 하트 페이지 조회에 성공했습니다."),
    SENDER_LIST_QUERY_FAIL(400, "M005", "받은 하트 페이지 조회에 실패했습니다."),
    RECEIVER_LIST_QUERY_SUCCESS(200, "M006", "보낸 하트 페이지 조회에 성공했습니다."),
    RECEIVER_LIST_QUERY_FAIL(400, "M006", "보낸 하트 페이지 조회에 실패했습니다."),
    SUMMARY_DETAIL_GET_SUCCESS(200, "M007", "매칭 현황 페이지 조회에 성공했습니다."),
    SUMMARY_DETAIL_GET_FAIL(400, "M007", "매칭 현황 페이지 조회에 실패했습니다."),
    NOTIFICATION_LIST_QUERY_SUCCESS(200, "M008", "알림 목록 조회에 성공했습니다."),
    NOTIFICATION_LIST_QUERY_FAIL(400, "M008", "알림 목록 조회에 실패했습니다."),
    NOTIFICATION_COUNT_QUERY_SUCCESS(200, "M009", "알림 개수 조회에 성공했습니다."),
    NOTIFICATION_COUNT_QUERY_FAIL(400, "M009", "알림 개수 조회에 실패했습니다."),
