...
import com.now_here5.now_here.infra.email.repository.EmailMemoryRepository;
...
public class EmailCodeService {
    ...
    public boolean sendRegisterCode(EmailRequestDto emailRequestDto) {
        try {
            ...
            emailMemoryRepository.saveCheckCode(emailRequestDto.getEmail(), randomCode); // 랜덤 번호, 이메일 저장.
    ...
    public boolean checkRegisterCode( String email, String code) {
        ...
        emailMemoryRepository.deleteEmail(email);
        return result;
    }
